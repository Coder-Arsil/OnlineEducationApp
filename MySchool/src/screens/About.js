  ...
  const About = () => {
    return (
      <View style={styles.aboutContainer}>
        <Text style={styles.mainHeader}> Muhammad Arsil </Text>
        <Text style={styles.paraStyle}> I am a Front End developer 😀 </Text>
  
        <View>
          <Image
            style={styles.imgStyle}
            source={require("../../images/ArsilMalek.png")}
          />
        </View>
        ...
        <View style={styles.menuContainer}>
          <TouchableOpacity
            ...
            onPress={() =>
              Linking.openURL("https://www.instagram.com/arsilmalek7/")
            }>
            <Image
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              Linking.openURL(
                "https://www.youtube.com/channel/UCQAhHBxFTnkZxy-V4hZ8X_w"
              )
            }>
            <Image
              style={styles.iconStyle}
